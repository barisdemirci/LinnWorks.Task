...
using LinnWorks.Processor.MicroService;

namespace LinnWorks.Processor.MicroService.Tests
{
    public class FunctionTest
    {
        ...
        public async System.Threading.Tasks.Task TestS3EventLambdaFunction()
        {
            ...
            var bucketName = "lambda-LinnWorks.Processor.MicroService-".ToLower() + DateTime.Now.Ticks;
            var key = "text.txt";
