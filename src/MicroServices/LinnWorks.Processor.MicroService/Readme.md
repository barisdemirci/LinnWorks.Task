...
Execute unit tests
```
    cd "LinnWorks.Processor.MicroService/test/LinnWorks.Processor.MicroService.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "LinnWorks.Processor.MicroService/src/LinnWorks.Processor.MicroService"
